        ...
        <div className="p-6 overflow-y-auto space-y-5 flex-1">
          ...
          {activeTab === 'backup' && (
            <div className="space-y-4">
              ...
              <div className="p-3.5 rounded-2xl bg-slate-50/70 dark:bg-slate-800/50 border border-slate-200/80 dark:border-slate-800 flex items-center justify-between">
                <div className="text-xs text-slate-500 font-mono">
                  Prefer text format? Copy the raw backup data directly.
                </div>
                <button
                  onClick={handleCopyJson}
                  className="px-3 py-1.5 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-xs font-mono font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition-all flex items-center gap-1.5 shadow-sm"
                >
